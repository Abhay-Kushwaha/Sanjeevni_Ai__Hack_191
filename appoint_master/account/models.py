...
class User(AbstractUser):
    ...
    state_name = models.CharField(max_length=100,choices=STATE_Name_CHOICES,default='Uttar Pradesh')
    ...
    #         self.patient_id = uuid.uuid4().hex[:8]  # 8-character unique ID { a1b2c3d4 } ..........
...
# Create a model for Patient ID(aadhar number)
...
class Prescription(models.Model):
    ...
    prescribed_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='doctor_prescriptions')
    prescribed_for_patient = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='patient_prescriptions')
    content = models.TextField('Prescription Details')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    
    def __str__(self):
        return f"Prescription for {self.appointment.appoint_id}"
