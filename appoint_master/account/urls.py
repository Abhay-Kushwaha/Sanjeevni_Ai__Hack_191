...
from appoint_app.views import dashboard, home, terms, faq,blog
...
urlpatterns = [
    ...
    path("video-call-patient/<str:appointment_id>/", views.video_call_patient, name='video-call-patient'),
    path("video-call/<str:appointment_id>/", views.video_call, name='video-call'),

    path('add-prescription/<str:appoint_id>/', views.add_or_edit_prescription, name='add_prescription'),
    path('view-prescription/<str:appoint_id>/', views.view_prescription, name='view_prescription'),
    path('list-prescription/', views.list_prescription, name='list_prescription'),
